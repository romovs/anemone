...
public class ComWin extends HWindow {
	...
	static Coord moc = new Coord(305, 10), mdc = new Coord(305, 30), ooc = new Coord(325, 10), odc = new Coord(325, 30), inic = new Coord(220, 60),
			balc = new Coord(270, 60), intc = new Coord(320, 60), swc = new Coord(315, 17), shc = new Coord(315, 37);

	static Color offcol = new Color(255, 0, 0), offemty = new Color(128, 64, 64), defcol = new Color(0, 0, 255), defemty = new Color(64, 64, 128);
