...
public class BuddyWnd extends Window {
	...
	public static final Color[] gc = new Color[] { new Color(255, 255, 255), new Color(64, 255, 64), new Color(255, 64, 64), new Color(96, 160, 255),
			new Color(0, 255, 255), new Color(255, 255, 0), new Color(211, 64, 255), new Color(255, 128, 16), };
	...
	/*
	 * static { Widget.addtype("buddy", new WidgetFactory() { public Widget
	 * create(Coord c, Widget parent, Object[] args) { return(new BuddyWnd(c,
	 * parent)); } }); }
	 */
