...
public class MenuGrid extends Widget {
	...
	public static String[] moveAttacks = { "thunder", "berserk", "dash", "feignflight", "flex", "butterfly", "jump", "advpush", "seize", "slide",
			"throwsand" };
	...
	/*
	 * String getAttackName(String[] ad){ String name = null; for(int i = 0; i <
	 * ad.length; i++){ // new if(!ad[i].contains("atk") ){ name =
	 * soakAttackCandidates(ad[i]); } }
	 * 
	 * return name; }
	 * 
	 * String soakAttackCandidates(String name){ for(int i = 0; i <
	 * moveAttacks.length; i++){ // new if(moveAttacks[i].contains(name) ){
